...
contains
  ...
  subroutine sfc_nst_run                                          &
       ...
       sfcemis, dlwflx, sfcnsw, rain, timestep, kdt, solhr,       &
    ...
    use module_nst_water_prop, only: density,rhocoef,compjd,grv, sw_ps_9b
    ...
    !  ---  inputs:
    integer, intent(in) :: im, kdt, nstf_name1, nstf_name4, nstf_name5
    ...
    real (kind=kind_phys), dimension(:), intent(in) :: ps, u1, v1,  &
         ...
         prsl1, prslki, prsik1, prslk1, xlon                        &
    ...
    real(kind=kind_phys) :: alpha,beta,rho_w,f_nsol,sss,sep, cosa,sina,taux,tauy,grav,dz,t0,ttop0,ttop
    ...
    !
    real (kind=kind_phys), parameter :: alps=0.75,bets=0.75,gams=0.15, ws10cr=30., &
         conlf=7.2e-9, consf=6.4e-8
    !
    !======================================================================================================
