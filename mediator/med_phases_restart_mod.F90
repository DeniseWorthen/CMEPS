...
!=================================================================================
  ...
  subroutine med_phases_restart_write(gcomp, rc)
    ...
    call ufs_trace("cmeps", "med_phases_restart_write", "B")
    ...
    call ufs_trace("cmeps", "med_phases_restart_write", "E")
  ...
  subroutine med_phases_restart_read(gcomp, rc)
    ...
    !---------------------------------------
    call ufs_trace("cmeps", "med_phases_restart_read", "B")
    call t_startf('MED:'//subname)
    call ESMF_LogWrite(trim(subname)//": called", ESMF_LOGMSG_INFO)
    rc = ESMF_SUCCESS
    ...
    call ufs_trace("cmeps", "med_phases_restart_read", "E")
