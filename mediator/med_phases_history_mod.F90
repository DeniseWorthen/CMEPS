...
!===============================================================================
  ...
  subroutine med_phases_history_write(gcomp, rc)
    ...
    rc = ESMF_SUCCESS
    call ufs_trace("cmeps", "med_phases_history_write", "B")
    ...
    call ufs_trace("cmeps", "med_phases_history_write", "E")
  ...
  subroutine med_phases_history_write_med(gcomp, rc)
    ...
    !---------------------------------------
    rc = ESMF_SUCCESS
    call ufs_trace("cmeps", "med_phases_history_write_med", "B")
    ...
    call ufs_trace("cmeps", "med_phases_history_write_med", "E")
  ...
  subroutine med_phases_history_write_lnd2glc(gcomp, fldbun_lnd, rc, fldbun_glc)
    ...
    rc = ESMF_SUCCESS
    call ufs_trace("cmeps", "med_phases_history_write_lnd2glc", "B")
    ...
    call ufs_trace("cmeps", "med_phases_history_write_lnd2glc", "E")
  ...
  subroutine med_phases_history_write_comp(gcomp, compid, rc)
    ...
    !---------------------------------------
    rc = ESMF_SUCCESS
    call ufs_trace("cmeps", "med_phases_history_write_comp", "B")
    ...
    call ufs_trace("cmeps", "med_phases_history_write_comp", "E")
