module med_internalstate_mod
  ...
  ! Coupling mode
  character(len=CS), public :: coupling_mode ! valid values are [cesm,ufs.nfrac,ufs.frac,ufs.nfrac.aoflux,ufs.nfrac.regional,ufs.frac.aoflux,hafs,hafs.mom6]
...
!=====================================================================
  ...
  subroutine med_internalstate_defaultmasks(gcomp, rc)
    ...
    if ( trim(coupling_mode(1:3)) == 'ufs' .and. trim(coupling_mode) /= 'ufs.nfrac.regional') then
