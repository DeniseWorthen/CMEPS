...
!-----------------------------------------------------------------------------
  ...
  subroutine med_phases_prep_ocn_accum(gcomp, rc)
    ...
    call ufs_trace("cmeps", "med_phases_prep_ocn_accum", "B")
    ...
    call ufs_trace("cmeps", "med_phases_prep_ocn_accum", "E")
  ...
  subroutine med_phases_prep_ocn_avg(gcomp, rc)
    ...
    rc = ESMF_SUCCESS
    call ufs_trace("cmeps", "med_phases_prep_ocn_avg", "B")
    ...
    call ufs_trace("cmeps", "med_phases_prep_ocn_avg", "E")
